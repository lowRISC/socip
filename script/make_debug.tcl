...
set files [list \
               ...
               [file normalize $origin_dir/src/socip/ariane/wrap_top.sv] \
               [file normalize $origin_dir/src/socip/ariane/display_top.sv] \
               [file normalize $origin_dir/src/socip/ariane/nexys4ddr_display.v] \
               [file normalize $origin_dir/src/socip/ariane/sevensegment.v] \
               ...
               [file normalize $origin_dir/src/socip/ariane/crossbar_socip_test.sv] \
	       [file normalize $origin_dir/src/socip/jtag_xilinx/jtag_dummy.v] \
...
set_property "top" "wrap_top" [get_filesets sources_1]
...
set files [list [file normalize "src/socip/constraint/pin_plan_debug.xdc"]]
